...
<body>
    ...
    <div class="track-container">
        <a href="{{route('donationHistory')}}" class="back-btn"><i class="fa-solid fa-arrow-left"></i></a>
        ...
        <div class="order-summary">
            <div class="order-info">
                ...
                <div>
                    <h4>Donation: Cloths</h4>
                    <p>Pickup ID: #12346</p>
                    <p>Quantity: 5 Garments | NGO:Goonj Foundation</p>
                    <!-- <p>₹217</p> -->
                </div>
            </div>
            <div class="status">
        ...
        <section class="track-order">
            ...
            <div class="timeline">
                ...
                <div class="step active">
                    <div class="dot truck">
                        <img src="./assets/image/Mask group.png" alt="Delivery Truck">
                    </div>
                    <div class="content">
                        <div class="info">
                            <h4>Delivery to NGO</h4>
