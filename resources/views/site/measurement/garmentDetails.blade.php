...
<body>
    ...
    <div class="checkout-container">
        ...
        <div class="checkout-grid" style="display:flex;gap:20px;align-items:flex-start;flex-wrap: wrap;">
            <div class="checkout-left" style="flex:1;min-width:300px;">
                ...
                <div class="popup-overlay" id="alterationPopup" aria-hidden="true">
                    <div class="popup popup-alt">
                        <button class="close-popup" id="closePopup">&times;</button>
                        <h2>Enter Garment Details</h2>

                        <div class="special-instructions form-group">
                            <label style="font-weight:600;">Add Special Instructions</label>
                            <textarea placeholder="Type or Record instructions here..." style="width:100%; min-height:80px; padding:10px; border-radius:8px; border:1px solid #e7e7e7;"></textarea>
                        </div>

                        <div class="file-upload form-group">
                            <label style="font-weight:600;">Upload Garment Image</label>
                            <input type="file" id="fileInput" style="display:block;">
                        </div>

                        <div class="quantity-section form-group" style="text-align: left;">
                            <label style="font-weight:600;">Enter the Quantity/Number of Garments</label>
    ...
    <script>
        ...
        document.getElementById('goToOrders').addEventListener('click', () => {
            ...
            window.location.href = '{{route('home')}}'; // replace with actual orders page route
        });
