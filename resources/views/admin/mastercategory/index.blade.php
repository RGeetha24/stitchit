...
<div class="main">
    ...
    <div class="category-page" style="margin-top: 10px;">
        ...
        @if (session('success') || session('error'))
            <div id="toast"
                 class="toast {{ session('error') ? 'toast-error' : 'toast-success' }}">
            ...
            <div class="left">
                ...
                <div class="table-container">
                    <div class="recent-header" style="display: flex; align-items: center; justify-content: space-between;">
                        <h1>Main Category</h1>
                        <a href="{{ route('admin.category.create') }}" class="refresh-btn">Add Category</a>
                    </div>
                                    ...
                                    <td>
                                        <div style="display:flex; gap:8px; align-items:center;">
                                            <button
                                                ...
                                                data-image="{{ $category->image ? asset('uploads/mastercategory/'.$category->image) : '' }}"
                                            >
                                                <i class="ri-eye-line"></i>
                                            </button>
                                            <a href="{{ route('admin.category.edit', $category->id) }}" title="Edit"><i class="ri-edit-line"></i></a>
