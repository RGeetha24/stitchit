...
<div class="main">
    ...
    <div class="category-page" style="margin-top: 10px;">
        <div class="table-container">
            ...
            <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data" class="category-form">
                @csrf
                ...
                <div class="cat-grid">
                    <div class="box">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="master_category_id" name="master_category_id" value="{{ old('master_category_id') }}">
                        </div>

                        <div class="form-group">
                            <label for="name">Name *</label>
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g., Custom Tailoring">
                        </div>
                        <div class="form-group">
                            <label for="slug">Slug *</label>
                            <input type="text" id="slug" name="slug" value="{{ old('slug') }}" required placeholder="e.g., custom-tailoring">
                        </div>
                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea id="description" name="description" rows="4" placeholder="Short description (optional)">{{ old('description') }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="price">Price (₹)</label>
                            <input type="number" id="price" name="price" value="{{ old('price') }}" min="0" step="0.01" placeholder="e.g., 500.00">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="Comma separated">
                        </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="save-cat-btn">Save Service</button>
